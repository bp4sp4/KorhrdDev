    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.textNoMargin}>
          모든 클래스명은 <strong>소문자와 언더스코어(_)</strong>만 사용합니다. 
      ...
      <section className={styles.section}>
        ...
        <div className={styles.subsection}>
          ...
          <p className={styles.text}>
            ...
            예를 들어 레이아웃은 <code>.layout_</code>, 버튼은 <code>.btn_</code>으로 시작합니다.
          </p>
...
.text_helper`} />
        ...
        <div className={styles.subsection}>
          ...
          <p className={styles.text}>
            ...
            우리는 <strong>언더스코어(_) 하나만 사용</strong>합니다.
          </p>
...
className={styles.block_element_modifier}`} />
        ...
        <div className={styles.subsection}>
          ...
          <ul className={styles.list}>
            <li>소문자와 언더스코어(_)만 사용합니다</li>
            <li>의미 있는 단어를 사용합니다 (약어는 피하세요)</li>
            <li>클래스명은 최대 3단계까지만 중첩합니다</li>
            <li>상태를 나타낼 때는 <code>.is_</code> 접두사를 사용합니다</li>
          </ul>
        </div>
      </section>
    </div>
